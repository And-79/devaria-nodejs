...
const validarOperador = (validarOperador) => {
    switch (operador) {
        case '+' :
        case '-' :
        case '/' :
                    ...
                    if(operadorValidado){
                        switch(operadorValidado){
                            ...
                            case '-' : console.log('operador selecionado subtracao resultado ${numerovalidado1} - ${numeroValidado2} = ${numeroValidado1 - numeroValidado2}');
                                break;
                            case '*' : console.log('operador selecionado multiplicacao resultado ${numerovalidado1} * ${numeroValidado2} = ${numeroValidado1 * umeroValidado2}');
                                break;
